...
const Product = ({ title, description, imageSrc, website }) => {
  return (
    <div className="relative w-full sm:w-1/2 max-w-xl p-6  sm:mb-0 font-poppins mr-2 mt-2 rounded-lg shadow-lg dark:border-gray-600 transition duration-500 ease-in-out transform opacity-100 translate-y-0" style={{backgroundImage: "linear-gradient(to right, #37136B, #94138B)"}}>
